...
```go
import (
    logMiddleware "github.com/garin-allo/log/middleware/echo"
...
```go
import logMiddleware "github.com/garin-allo/log/middleware/fiber"
...
```go
import logMiddleware "github.com/garin-allo/log/middleware/gin"
...
```go
import logMiddleware "github.com/garin-allo/log/middleware/grpc"
...
```go
import (
    logGorm "github.com/garin-allo/log/extension/gorm"
